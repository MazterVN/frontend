describe('Working with roles feature by Tester Role', () => {
  ...
  it('create student-attendance', () => {
    ...
    cy.dataTestId('date-picker-field').clear().type('ច, 03/03/2025')
    cy.get('body').click(0, 0).wait(300)
    cy.dataTestId('day-0-0').click().wait(200)

    cy.dataTestId('attendance-0-is-absent')
      .click()
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')
    cy.dataTestId('attendance-0-note')
      .type('អត់ចង់ជួបមុខគ្រូ')
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')

    cy.selectSetting('attendance-1-type', 'វ', 'present_late_attendance_type')
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')
    cy.dataTestId('attendance-1-late-time')
      .type('10')
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')
    cy.dataTestId('attendance-1-note')
      .type('បែកកង់តាមផ្លូវ')
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')

    cy.dataGridSearch('attendance', 'សម្រាប់តេស្ដ')
      .wait(300)
    cy.dataTestId('attendance-0-checked')
      .click()
      .wait(1500)
      .submitAssertSuccessful('បានរក្សាទុកជោគជ័យ')
  })
