...
import { DialogRoot, DialogTrigger, DialogPortal, DialogContent, DialogTitle, DialogDescription, DialogClose, VisuallyHidden, useForwardPropsEmits } from 'reka-ui'
import { reactivePick } from '@vueuse/core'
import type { ButtonProps, ModalEmits, ModalProps, ModalSlots } from '@nuxt/ui'
...
// @ts-ignore
const tv = createTV(_appConfig.ui?.tv)
