...
const store = useBestPracticeStore()
    ...
    >
      <div class="sm:col-span-8">
        <UFormField
          ...
          label="ឈ្មោះ"
        >
          <UInput v-model="store.item.name" />
        </UFormField>
      </div>
      ...
      <div class="sm:col-span-full">
        <UFormField
          ...
          label="ការពិពណ៌នា"
        >
          <UTextarea v-model="store.item.description" />
        </UFormField>
      </div>
        ...
        <UFormField label="លម្អិត">
          ...
          >
            <Table class="table-fixed">
              ...
              <TableBody>
                <TableRow
                  v-for="(row, index) in store.item.bestPractices"
                  :key="row.id"
                >
                  <TableCell>
                    <UFormField
                      :name="`bestPractices.${index}.startCondOp`"
                    >
                      <USelect
                  ...
                  <TableCell>
                    <UFormField
                      :name="`bestPractices.${index}.startCondValue`"
                    >
                      <UInput
                  ...
                  <TableCell>
                    <UFormField
                      :name="`bestPractices.${index}.endCondOp`"
                    >
                      <USelect
                  ...
                  <TableCell>
                    <UFormField
                      :name="`bestPractices.${index}.endCondValue`"
                    >
                      <UInput
                  ...
                  <TableCell>
                    <UFormField
                      :key="`bestPractices-${row.id}-gradeLevelId`"
                      :name="`bestPractices.${index}.gradeLevelId`"
                    >
                      <DropdownList
                        :id="`bestPractices-${index}-gradeLevelId`"
                  ...
                  <TableCell class="text-center">
                    <TrashButton @click="store.removeDetail(row.id)" />
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
